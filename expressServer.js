...
class ExpressServer {
    ...
    setupMiddleware() {
      ...
      this.app.get('/', (req, res) => res.sendFile(path.join(__dirname,'html','Home.html')));
			...
			this.app.get('/createproduct', (req, res) => res.sendFile(path.join(__dirname,'html','createproduct.html')));
			this.app.get('/createproduct/:id', (req, res) => res.sendFile(path.join(__dirname,'html','createproduct.html')));
